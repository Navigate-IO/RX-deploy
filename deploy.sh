...
# installs JDK, RaspAP, drone-public), then configures everything for RX.
#
# Usage:
#   git clone https://github.com/Navigate-IO/RX-deploy.git
#   cd RX-deploy
#   sudo bash deploy.sh
